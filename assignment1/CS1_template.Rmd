...
```
**Conclusion:** \par
The for loop is for the ratio of Fibonacci numbers overall at n=200 and n=2000 faster than the while loop.
...
```
**Conclusion:** \par
For small n the sequence fluctuates, but stabilizes quite fast at around n=~10 and it it is known, that the Fibonacci sequence converges to the golden ratio:
