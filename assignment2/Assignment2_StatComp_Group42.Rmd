---
title: "Case Study 2"
author: "Crasnianec Oliver, Kovsca Lorenz, Asche Nikolai"
date: "2026-04-02"
output: pdf_document
---
...
\begin{tabular}{p{0.75\textwidth} p{0.15\textwidth}}
\toprule
\textbf{AI usage} & \textbf{Task a}\\
\midrule
\textit{ChatGPT 5.3: Recommending code snippets for importing data from .txt with many white spaces between columns}
& medium \\
\bottomrule
\end{tabular}
\end{table}
